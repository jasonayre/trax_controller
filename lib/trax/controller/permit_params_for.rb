  ...
  module Controller
    module PermitParamsFor
      ...
      def params_permitter_for_action
        ...
        return self.trax_params_permitters[:save] if self.trax_params_permitters.key?(:save) && (action == 'create' || action == 'update')
      ...
      def build_resource_params
        ...
        params_permitter_for_action.new(_params).to_hash
      end
